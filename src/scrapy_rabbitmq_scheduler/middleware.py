...
class RabbitMQMiddleware(object):
    ...
    def process_response(self, request, response, spider):
        ...
        if self.scheduler.__class__.__name__== "MqMixCache":
            logging.warning(
                "The MqMixCache's scheduler is not compatible with this middleware and this RabbitMQMiddleware will be shut down"
                )
            return response
